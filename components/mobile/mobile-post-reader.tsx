    ...
    <ErrorBoundary>
      ...
      <div className="mpr-wrap">
        ...
        <div className="mpr-body">
          ...
          {/* Inline social links — mobile only (floating SocialFooter hidden on mobile) */}
          <div className="flex justify-center gap-6 pt-10 pb-4">
            {[
              ...
              <a
                ...
                aria-label={s.label}
                className="flex items-center justify-center w-11 h-11 rounded-full text-[rgba(255,255,255,0.5)] hover:text-[rgba(255,255,255,0.9)] transition-colors"
              >
